...
car_7 = Car.new(name: 'Toyota Camry', car_type: 'Sedan', transmission: "Automatic", price: 80, car_description: 'Red, Petrol, Bluetooth Enabled, SatNav Enabled', user: user)
car_7.save!
...
car_11 = Car.new(name: 'Tesla Model 3', car_type: 'Saloon', transmission: "Automatic", price: 210, car_description: 'Green, Petrol, Bluetooth Enabled, SatNav Enabled', user: user)
car_11.save!

car_12 = Car.new(name: 'Volkswagen Golf', car_type: 'Hatchback', transmission: "Manual", price: 120, car_description: 'Grey, Electric, Bluetooth Enabled, SatNav Enabled', user: user2)
car_12.save!
